...
/**
 * Created by seekingL on 2016/7/29.
 *
 */
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /** * 判断传入的是横向的还是纵向的 * * @param orientation */
    ...
    /** * 绘制 根据传入的是水平的还是垂直的 * * @param c * @param parent * @param state */
    @Override
    ...
    /** * linear 垂直列表 * * @param c * @param parent */
