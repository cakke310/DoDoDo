...
public class PagerTab extends ViewGroup {
	...
	private int mIndicatorColor = 0xFF0099e0;//指示器颜色
	...
	private int mTabTextColorResId = R.color.indicator_text_color; //tab文字颜色
	...
	private void init() {
		...
		mLeftEdge = new EdgeEffectCompat(mContext);
		mRightEdge = new EdgeEffectCompat(mContext);
	}
	...
	private void addIconTab(final int position, int resId) {
		ImageButton tab = new ImageButton(mContext);
